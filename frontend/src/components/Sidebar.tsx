...
export function Sidebar() {
  ...
  useEffect(() => {
    // Dispatch initial state so App can sync
      ...
      <div className="flex items-center gap-3 px-3 py-4 flex-shrink-0">
        ...
        {!collapsed && (
          <div className="min-w-0 flex-1">
            <div className="text-ink font-bold text-sm leading-tight truncate">Mountain Knife</div>
            <div className="text-muted text-xs leading-tight">Collection</div>
          </div>
        )}
        {/* Collapse toggle */}
        <button
          ...
          className="flex-shrink-0 text-muted hover:text-ink transition-colors p-1 rounded-md hover:bg-border/30"
        >
